...
class StudyPlanContextBuilder(context: Context) {
    ...
    fun buildForDate(date: String): StudyPlanContext {
        ...
        return StudyPlanContext(
            ...
            planEarliestTime = settingsRepository.getPlanEarliestTime(),
            planLatestTime = settingsRepository.getPlanLatestTime(),
            generationStartTime = generationStartTime(normalizedDate)
        )
    }
